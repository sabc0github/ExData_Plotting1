...
##      * Name the plot files as plot2.png.
##      * Create a separate R code file (plot2.R) that constructs the corresponding plot, i.e. code in plot2.R constructs the plot2.png plot. 
