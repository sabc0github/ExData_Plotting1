...
##      * Name the plot files as plot1.png.
##      * Create a separate R code file (plot1.R) that constructs the corresponding plot, i.e. code in plot1.R constructs the plot1.png plot. 
