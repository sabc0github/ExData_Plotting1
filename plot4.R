...
##      * Name the plot files as plot4.png.
##      * Create a separate R code file (plot4.R) that constructs the corresponding plot, i.e. code in plot4.R constructs the plot4.png plot. 
...
plot4 <- function(){
        ...
        ## Add Legend to the Line Plot 2
        legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd = 1, col = c("Black", "Red", "Blue"))

        ## Construct Line plot 3
